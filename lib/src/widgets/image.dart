...
class _ImageState extends State<Image> with WidgetsBindingObserver {
  ...
  void _updateInvertColors() {
    _invertColors =
        MediaQuery.maybeInvertColorsOf(context) ?? SemanticsBinding.instance.accessibilityFeatures.invertColors;
  }
  ...
  Widget build(BuildContext context) {
    ...
    // HACK: Differs from Flutter's Image.
    final fakeKey = _imageInfo?.debugLabel != null ? ValueKey(_imageInfo!.debugLabel) : null;
